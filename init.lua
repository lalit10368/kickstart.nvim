...
-- Settings to navigate the buffers
vim.keymap.set('n', '<M-h>', '<cmd>bprev<CR>', { desc = 'Go to previous [B]uffer' })
vim.keymap.set('n', '<M-l>', '<cmd>bnext<CR>', { desc = 'Go to next [B]uffer' })
